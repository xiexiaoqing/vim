...
" "colorscheme
" "set syntax highlight for vim


" " auto start nerdtree when start vim
...
" nnoremap ddp
"
" " exchange character under cursor with the next character without moving the
" cursor
" nnoremap gc xph
"
" " exchange word under cursor with the next word without moving the cursor , switch the word
nnoremap ws "_yiw:s/(%#\w+)(_W+)(\w+)/\3\2\1/
"
" " push word under cursor to the left
" nnoremap 
" "_yiw?\w+_W+%#:s/(%#\w+)(_W+)(\w+)/\3\2\1/
"
" " push word under cursor to the right
" nnoremap 
" "_yiw:s/(%#\w+)(_W+)(\w+)/\3\2\1//\w+_W+
...
" the
" " search while inputing, incremental
set incsearch
"
" " mapping of below)
set hlsearch
...
set ignorecase
" " if user uppercase, casesensitive match
set smartcase
"
...
set t_Co=256
"
" " Enable use of the mouse for l modes
set mouse=a
"
...
" " file explorer
nnoremap es :Sexplore
nnoremap eh :Hexplore
" nnoremap fs :Sexplore . #f is for find char in Virtual mode
...
" " auto complete
" inoremap j ((pumvisible())?("<C-n>"):("j"))
" inoremap k ((pumvisible())?("<C-p>"):("k"))

"" insert mode -> other mode
" " use ctrp-[ , raw support
"
" " esc 
inoremap jjj <C-[>
